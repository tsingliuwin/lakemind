...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    systemPromptDesc: "模型每次调用收到的固定系统提示词（只读，随软件内置）",
    tenetsSection: "共享准则库",
    tenetsDesc: "随软件分发、所有工作区共享的分析准则（只读，存储于 ~/.lakemind/tenets/）",
  ...
  en: {
    ...
    systemPromptDesc: "The fixed system prompt sent to the model on every call (read-only, built into the app)",
    tenetsSection: "Shared Tenets Library",
    tenetsDesc: "Shared analysis tenets bundled with the app across all workspaces (read-only, stored at ~/.lakemind/tenets/)",
