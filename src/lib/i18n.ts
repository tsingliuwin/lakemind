...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    settingsDatabasesDesc: "配置与管理外部 PostgreSQL / MySQL 数据库连接",
    ...
    unlinkFromWorkspaceTooltip: "取消关联项目",
  ...
  en: {
    ...
    settingsDatabasesDesc: "Configure and manage external PostgreSQL / MySQL database connections",
    ...
    unlinkFromWorkspaceTooltip: "Unlink from project",
    // LeftNav External Data Explorer
